...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EarthpointsApi.ClientCredentialsResponseDto();
  });
  ...
  describe('ClientCredentialsResponseDto', function() {
    it('should create an instance of ClientCredentialsResponseDto', function() {
      // uncomment below and update the code to test ClientCredentialsResponseDto
      //var instance = new EarthpointsApi.ClientCredentialsResponseDto();
      //expect(instance).to.be.a(EarthpointsApi.ClientCredentialsResponseDto);
    });
