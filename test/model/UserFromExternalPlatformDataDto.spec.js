...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EarthpointsApi.UserFromExternalPlatformDataDto();
  });
  ...
  describe('UserFromExternalPlatformDataDto', function() {
    it('should create an instance of UserFromExternalPlatformDataDto', function() {
      // uncomment below and update the code to test UserFromExternalPlatformDataDto
      //var instance = new EarthpointsApi.UserFromExternalPlatformDataDto();
      //expect(instance).to.be.a(EarthpointsApi.UserFromExternalPlatformDataDto);
    });
